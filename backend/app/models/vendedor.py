...
class Vendedor(Base):
    ...
    produtos_vendidos = relationship("Produto", back_populates="vendedor", foreign_keys="Produto.id_vendedor")
    produtos_comprados = relationship("Produto", back_populates="comprador", foreign_keys="Produto.id_comprador")
