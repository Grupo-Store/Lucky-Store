...
from sqlalchemy import Column, Integer, Numeric, DateTime, UniqueConstraint, ForeignKey
...
class DashboardGoal(Base):
    ...
    __table_args__ = (
        UniqueConstraint("ano", "mes", "id_loja", name="uq_dashboard_goal_ano_mes_loja"),
    )
