...
from sqlalchemy import Column, ForeignKey, Numeric, String, Date, DateTime, UniqueConstraint  # type: ignore[import]
...
class MetaVendedor(Base):
    ...
    __table_args__ = (
        UniqueConstraint("id_vendedor", "ano_mes", "tipo", name="uq_meta_vendedor_mes_tipo"),
    )
